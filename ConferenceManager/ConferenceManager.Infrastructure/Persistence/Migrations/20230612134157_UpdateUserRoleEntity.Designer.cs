...
namespace ConferenceManager.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230612134157_UpdateUserRoleEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConferenceManager.Domain.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConferenceManager.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConferenceManager.Domain.Entities.Comment", b =>
                {
                    b.HasOne("ConferenceManager.Domain.Entities.User", "CreatedBy")
                        .WithMany("CreatedComments")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ConferenceManager.Domain.Entities.User", "ModifiedBy")
            ...
            modelBuilder.Entity("ConferenceManager.Domain.Entities.ConferenceParticipant", b =>
                {
                    ...
                    b.HasOne("ConferenceManager.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ConferenceManager.Domain.Entities.ReviewPreference", b =>
                {
                    b.HasOne("ConferenceManager.Domain.Entities.User", "Reviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("ConferenceManager.Domain.Entities.UserConferenceRole", b =>
                {
                    ...
                    b.HasOne("ConferenceManager.Domain.Entities.Role", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ConferenceManager.Domain.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ConferenceManager.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
