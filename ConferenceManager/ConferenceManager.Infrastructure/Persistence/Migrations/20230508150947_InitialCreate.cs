        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Acronyn = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    PrimaryResearchArea = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SecondaryResearchArea = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    AreaNotes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    OrganizerWebpage = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conferences_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Conferences_AspNetUsers_ModifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConferenceParticipants", x => new { x.UserId, x.ConferenceId });
                    table.ForeignKey(
                        name: "FK_ConferenceParticipants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Submissions_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Papers_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Papers_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Papers_Submissions_SubmissionId",
                        column: x => x.SubmissionId,
                        principalTable: "Submissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewPreferences", x => new { x.SubmissionId, x.ReviewerId });
                    table.ForeignKey(
                        name: "FK_ReviewPreferences_AspNetUsers_ReviewerId",
                        column: x => x.ReviewerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewPreferences_Submissions_SubmissionId",
                        column: x => x.SubmissionId,
                        principalTable: "Submissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conferences_CreatedById",
                table: "Conferences",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Conferences_ModifiedById",
                table: "Conferences",
                column: "ModifiedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Papers_ModifiedById",
                table: "Papers",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_Papers_SubmissionId",
                table: "Papers",
                column: "SubmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewPreferences_ReviewerId",
                table: "ReviewPreferences",
                column: "ReviewerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_ModifiedById",
                table: "Submissions",
                column: "ModifiedById");
        }
